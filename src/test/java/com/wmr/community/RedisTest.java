...
//                Integer.parseInt("ABC");
    ...
    public void testBitMap() {
        ...
        System.out.println(Arrays.toString(redisKey.getBytes()));
        ...
        Object execute = redisTemplate.execute(new RedisCallback<Object>() {
            ...
            public Object doInRedis(RedisConnection connection) throws DataAccessException {
                connection.bitOp(RedisStringCommands.BitOperation.OR,
                        redisKey.getBytes(StandardCharsets.UTF_8), redisKey2.getBytes(StandardCharsets.UTF_8),
                        redisKey3.getBytes(StandardCharsets.UTF_8), redisKey4.getBytes(StandardCharsets.UTF_8));
